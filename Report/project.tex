...
12 factor app - the 12 factor app, made use of environment variables in order to store application config, seperated the backing services, Processes, made use of codebase tracked in version control.
